import uuid
from sqlalchemy import Column, Float, DateTime, ForeignKey, Text, Boolean, Integer, String
...
class StudentResponse(Base):
    ...
    matched_answer = Column(Text, nullable=True)
    ...
    assigned_difficulty = Column(Float, nullable=True)
    question_difficulty = Column(Float, nullable=True)
    student_difficulty = Column(Float, nullable=True)
