...
from app.schemas.session.session_schema import SessionGenerateRequest, AnswerSubmissionRequest
...
@router.post("/{session_id}/complete", response_model=SuccessResponse)
