    ...
    def generate_question_bank(
        ...
        if subject.lower() in ("hindi", "gujarati"):
            ...
            system_prompt += (
                ...
                f"For {lang_name}, you MUST ONLY generate questions that use the EXACT original sentences, text, and terms from the "
                "textbook exercises (अभ्यास / स्वाध्याय) found at the end of the chapter, or that test the exact word meanings "
                "(शब्दार्थ / शब्द कोश) found in the glossary section. You are strictly prohibited from rephrasing, modifying, "
                "or changing the sentences of the textbook questions. For example, if a textbook sentence is 'शिकारी ज्यादा से ज्यादा "
                "चिड़ियों को निशाना बनाने...', you must use that exact sentence; do not alter it to 'सोनकौड़ी गौरैया को...'. Use the "
                "story text solely as context to determine the correct answers. Do not create any new questions.\n"
